      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="<?php echo base_url('Data_Acuan/update') ?>" name="number_validate" id="number_validate" novalidate="novalidate">
              <div class="control-group">
                <label class="control-label">Id_Acuan :</label>
                <div class="controls">
                  <input type="text" name="kode" id="min" value="<?php echo $acuan['id_acuan'] ?>" readonly/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Umur :</label>
                <div class="controls">
                  <input type="text" name="Umur" id="max" value="<?php echo $acuan['umur'] ?>"/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">pH Tanah  :</label>
                <div class="controls">
                  <input type="text" name="ph" id="number" value="<?php echo $acuan['pH'] ?>"/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Luas Tanam  :</label>
                <div class="controls">
                  <input type="text" name="luas" id="number" value="<?php echo $acuan['luas'] ?>"/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Jarak Tanam  :</label>
                <div class="controls">
                  <input type="text" name="jarak" id="number" value="<?php echo $acuan['jarak'] ?>"/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Tinggi Tanaman  :</label>
                <div class="controls">
                  <input type="text" name="tinggi" id="number" value="<?php echo $acuan['tinggi'] ?>"/>
                </div>
              </div>
              <div class="form-actions">
                <input type="submit" value="Edit" class="acuan">
              </div>
              </tbody>
            </form>
          </div>
