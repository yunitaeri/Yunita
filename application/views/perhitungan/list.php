              ...
              <ul>
                <li class="clearfix">
                  <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="<?php echo base_url('Perhitungan/hitung') ?>" name="number_validate" id="number_validate" novalidate="novalidate">
                        ...
                        <div class="controls">
                          <input type="text" name="umur" id="min" />
                        </div>
                        <label class="control-label">pH Tanah :</label>
                        <div class="controls">
                          <input type="text" name="pH" id="max" />
                        </div>
                        <label class="control-label">Luas Tanam :</label>
                        <div class="controls">
                          <input type="text" name="luas" id="max" />
                        </div>
                        <label class="control-label">Jarak Tanam :</label>
                        <div class="controls">
                          <input type="text" name="jarak" id="max" />
                        </div>
                        <label class="control-label">Tinggi Tanaman :</label>
                        <div class="controls">
                          <input type="text" name="tinggi" id="max" />
                        </div>
                      </div>
                    </div>
                    <center>
                      <a href="<?= base_url('Perhitungan/hitung') ?>">
