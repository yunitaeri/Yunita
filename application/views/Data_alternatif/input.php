      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="<?php echo base_url('Data_Alternatif/insert') ?>" name="number_validate" id="number_validate" novalidate="novalidate">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="nama_pupuk" id="max" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Nitrogen (N)  :</label>
                <div class="controls">
                  <input type="text" name="nitrogen" id="number" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Fosfor (P)  :</label>
                <div class="controls">
                  <input type="text" name="fosfor" id="number" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Kalium (K)  :</label>
                <div class="controls">
                  <input type="text" name="kalium" id="number" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Sulfur (S)  :</label>
                <div class="controls">
                  <input type="text" name="sulfur" id="number" />
                </div>
              </div>
              <div class="form-actions">
                <input type="submit" value="Tambah" class="alternatif">
              </div>
              </tbody>
            </form>
          </div>
