...
<!--Chart-box-->
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-striped table-bordered">
              <thead>
                <tr>
                  <th rowspan="2"> <h6>Kode</h6> </th>
                  <th rowspan="2"> <h6>Nama Pupuk</h6> </th>
                  <th colspan="4"> <h6>Kandungan Pupuk</h6> </th>
                  <th rowspan="2"> <h6>Aksi</h6> </th>
                </tr>
                <tr>
                  <th> N </th>
                  <th> P </th>
              ...
              <tbody>
                <?php $no=1; foreach ($alternatif as $value): ?>
                  <tr>
                    ...
                    <td>
                      <div class="fr">
                        <a href="<?php echo base_url('Data_alternatif/edit/').$value->id_jenis ?>" class="btn btn-warning btn-mini">Edit</a>
                        <a href="<?php echo base_url('Data_alternatif/hapus/').$value->id_jenis ?>" class="btn btn-danger btn-mini">Delete</a>
                      </div>
                    </td>
                  </tr>
                <?php endforeach; ?>
  ...
  <div> <a href="<?php echo base_url();?>Data_Alternatif/input" class="btn btn-primary btn-mini">Tambahkan</a></div>
<!--End-Chart-box-->
