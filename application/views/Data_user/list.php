              ...
              <tbody>
                <?php $no=1; foreach ($user as $value): ?>
                  <tr>
                    ...
                    <td>
                      <div class="fr">
                        <a href="<?php echo base_url('Data_user/edit/').$value->id_User ?>" class="btn btn-warning btn-mini">Edit</a>
                        <a href="<?php echo base_url('Data_user/hapus/').$value->id_User ?>" class="btn btn-danger btn-mini">Delete</a>
                      </div>
                    </td>
                  </tr>
                <?php endforeach; ?>
...
<div>
  <a href="<?php echo base_url();?>Data_User/input" class="btn btn-primary btn-mini">Tambahkan</a></div>
<!--End-Chart-box-->
